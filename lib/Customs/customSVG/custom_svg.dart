...
///
/// These methods are used by [CustomSvg], but can also be directly used e.g.
...
class Svg {
  ...
  /// A global override flag for [CustomSvg.cacheColorFilter].
  ///
  /// If this is null, the value in [CustomSvg.cacheColorFilter] is used. If it
...
class CustomSvg extends StatelessWidget {
  ...
  const CustomSvg(
    ...
    SvgTheme? theme,
    @Deprecated('This parameter is deprecated and is no longer implemented.')
  ...
  ///
  /// ```dart
  /// CustomSvg.asset('icons/heart.svg', package: 'my_icons')
  /// ```
  ///
